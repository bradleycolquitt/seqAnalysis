...
heatmap.2(vista.counts.norm.thresh.98[vista.counts.norm.thresh.98.ho$final$order,], trace="none", Rowv=F, breaks=seq(0,2000,100))
```
...
gg <- gg + stat_smooth(method="loess", span=.1)
gg
```

#### Hierachical clustering

Cosangle distance matrix from above.
