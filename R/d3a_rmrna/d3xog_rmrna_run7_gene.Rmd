...
levels(gene.read.fpkm.m$variable) <-  c("+/+ rep1", "+/+ rep2", "+/+ rep3", "+/-", "-/- rep1", "-/- rep2")
```
...
levels(gene.read.fpkm.c100.m$variable) <-  c("+/+ rep1", "+/+ rep2", "+/+ rep3", "+/-", "-/- rep1", "-/- rep2")
```
...
```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt, fig.width=6, fig.height=6, dev=c("png", "pdf") }
theme_set(theme_bw())
gg.rep <- ggplot(gene.read.fpkm.c100.m[gene.read.fpkm.c100.m$variable %in% c("+/+ rep1", "+/+ rep2", "+/+ rep3"),], aes(index, value, color=variable))
...
```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt_het, fig.width=6, fig.height=6, dev=c("png", "pdf")}
gg.rep <- ggplot(gene.read.fpkm.c100.m[gene.read.fpkm.c100.m$variable %in% c("+/+ rep1", "+/+ rep2", "+/+ rep3", "+/-"),], aes(index, value, color=variable))
gg.rep + geom_point() + scale_color_brewer(name="Dnmt3a", palette="Set1") + stat_smooth(se=F) + coord_cartesian(ylim=c(0, 5)) + labs(x="5hmC gene body index", y="log2(FPKM+1)") + theme(legend.position=c(.8, .3))
```

```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt_het_ko1, fig.width=6, fig.height=6, dev=c("png", "pdf")}
gg.rep <- ggplot(gene.read.fpkm.c100.m[gene.read.fpkm.c100.m$variable %in% c("+/+ rep1", "+/+ rep2", "+/+ rep3", "+/-", "-/- rep1"),], aes(index, value, color=variable))
gg.rep + geom_point() + scale_color_brewer(name="Dnmt3a", palette="Set1") + stat_smooth(se=F) + coord_cartesian(ylim=c(0, 5)) + labs(x="5hmC gene body index", y="log2(FPKM+1)") + theme(legend.position=c(.8, .3))
```

```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt_het_ko2, fig.width=6, fig.height=6, dev=c("png", "pdf")}
gg.rep <- ggplot(gene.read.fpkm.c100.m[gene.read.fpkm.c100.m$variable %in% c("+/+ rep1", "+/+ rep2", "+/+ rep3", "+/-", "-/- rep2"),], aes(index, value, color=variable))
gg.rep + geom_point() + scale_color_brewer(name="Dnmt3a", palette="Set1") + stat_smooth(se=F) + coord_cartesian(ylim=c(0, 5)) + labs(x="5hmC gene body index", y="log2(FPKM+1)") + theme(legend.position=c(.8, .3))
```
...
```{r d3xog_wt_het_ko_rmrna_run7_wt_ko_scatter, fig.width=5, fig.height=5, dev=c("png", "pdf")}
...
### Ordered by gene body 5hmC
```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt_het_ko, fig.width=6, fig.height=6, dev=c("png", "pdf")}
...
```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_gene_body_wt_het_ko_ratio,fig.width=6, fig.height=6, dev=c("png", "pdf") }
gg <- ggplot(gene.fpkm.mat.c100.m[grep("WT", gene.fpkm.mat.c100.m$variable),], aes(index, value, color=variable))
...
```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_ko_wt_ratio_gene_body_wt_het_ko, fig.width=6, fig.height=6, dev=c("png", "pdf")}
gg <- ggplot(gene.fpkm.mat.c100.m[-grep("WT", gene.fpkm.mat.c100.m$variable),], aes(index, value, color=variable))
gg + geom_point() + scale_color_brewer(name="Dnmt3a", palette="Set1") + stat_smooth(se=F) + coord_cartesian(ylim=c(0, 5)) + labs(x="5hmC gene body index", y="log2(FPKM+1)") + theme(legend.position=c(.8, .3))
```

```{r d3xog_wt_het_ko_rmrna_run7_fpkm_ordered_by_omp_hmc_ko_wt_ratio_gene_body_wt_het_ko_ratio,fig.width=6, fig.height=6, dev=c("png", "pdf") }
gg <- ggplot(gene.fpkm.mat.c100.m[grep("WT", gene.fpkm.mat.c100.m$variable),], aes(index, value, color=variable))
gg + geom_point() + scale_color_brewer(name="Dnmt3a", palette="Set1") + stat_smooth(se=F) + coord_cartesian(ylim=c(-1, 1)) + labs(x="5hmC gene body index", y="log2(FPKM+1)") + theme(legend.position=c(.8, .3))
```
...
```{r omp_ngn_icam_mrna_ucsc_fpkm_1log2_d3xog_wt_het_ko_rmrna_run7_sig_up, fig.height=6, fig.width=4, dev=c("png", "pdf") }
...
```{r d3xog_wt_het_ko_rmrna_run7_omp_ngn_icam_mrna_ucsc_fpkm_1log2_rna_class, fig.height=6, fig.width=4, dev=c("png", "pdf")}
...
```{r gene_whole_W200N50F50_mid_d3xog_hmc_mc_d3xog_wt_het_ko_rmrna_run7_sig_up, fig.height=6, fig.width=5, dev=c("png", "pdf")}
