...
gene.fpkm.mat.1 <- transform(gene.fpkm.mat.1, q2.q1=q2_FPKM - q1_FPKM, q3.q1=q3_FPKM - q1_FPKM)
...
gene.count.mat$gene <- gene[match(gene.count.mat$tracking_id, gene$test_id),"gene"]
...
gene.count.mat.1 <- transform(gene.count.mat.1, q2.q1=q2_count - q1_count, q3.q1=q3_count - q1_count)
