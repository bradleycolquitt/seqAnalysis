...
###############
AnnoSetSimp.calibrationCurve <- function(data=NULL, reads=NULL, pattern=NULL){
	...
	signal <- .extract(data@read_data, reads)@raw
        #coupling <- .extract(data@pattern_set, pattern)@coupling_vectors[[1]]
	...
	return(max_CCurve_signal_index)
