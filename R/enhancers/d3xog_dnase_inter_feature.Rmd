...
```{r}
d0.mod0 <- makeFeatureMatrix2("d3a_het_dnase_sort_q30_dnase_sub_igenome_ensembl_genes_extend5kb_nosex.bed_chr", "d3xog_hmc_mc", data_type="rpkm/mean")
d0.mod500 <- makeFeatureMatrix2("d3a_het_dnase_sort_q30_dnase_sub_igenome_ensembl_genes_extend5kb_nosex.bed_chr", "d3xog_hmc_mc", data_type="rpkm/mean", select="flank500")
d0.mod1000 <- makeFeatureMatrix2("d3a_het_dnase_sort_q30_dnase_sub_igenome_ensembl_genes_extend5kb_nosex.bed_chr", "d3xog_hmc_mc", data_type="rpkm/mean", select="flank1000")
