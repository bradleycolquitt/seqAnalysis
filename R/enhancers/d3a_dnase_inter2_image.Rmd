...
```{r}
wt.hmc <- makeImage("omp_hmc_rep1_q30_rmdup_extend300_mean_omp_hmc_rep2_q30_rmdup", "d3a_het_dnase_sort_q30_dnase_sub_igenome_ensembl_genes_extend5kb_nosex.bed_W25F200_both_chr", data_type="rpkm/mean", image=F)
ko.hmc <- makeImage("d3xog_ko_hmc_paired_q30", "d3a_het_dnase_sort_q30_dnase_sub_igenome_ensembl_genes_extend5kb_nosex.bed_W25F200_both_chr", data_type="rpkm/mean", image=F) 
...
gg.mid <- gg + geom_point(aes(color=variable)) + scale_color_manual(values=col2) + labs(title="Middle")
```
...
gg.flank <- gg + geom_point(aes(color=variable)) + scale_color_manual(values=col2) + labs(title="Flanking")
```
...
```{r}
gg <- ggplot(mid.c100.m, aes(index, value))
gg.mid1 <- gg + geom_point(aes(color=variable)) + scale_color_manual(values=col2) + labs(title="Middle") + coord_cartesian(ylim=c(0, 1))
```
...
```{r}
gg <- ggplot(mid.c100.m, aes(index, value))
gg.mid <- gg + geom_point(aes(color=variable)) + scale_color_manual(values=col2) + labs(title="Middle") + coord_cartesian(ylim=c(0, 1))
```
...
```{r}
gg <- ggplot(flank.c100.m, aes(index, value))
gg.flank <- gg + geom_point(aes(color=variable)) + scale_color_manual(values=col2) + labs(title="Flanking") + coord_cartesian(ylim=c(0, 1)) 
```
