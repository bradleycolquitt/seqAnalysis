...
anno.path <- "~/s2/lib/annotations"
anno_hires.path <- "~/s2/lib/annotations_hires"
...
samples.d3a_rpkm <- c("moe_d3a_wt_hmc_rpkm", "moe_d3a_wt_hmc_30M_rpkm", "moe_d3a_ko_hmc_rpkm")
