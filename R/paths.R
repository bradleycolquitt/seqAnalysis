...
group2.path <- "/media/storage/user/analysis/group2"
profile2.path <- "/media/storage2/analysis/profiles"
medip_split.path <- "~/s2/data/medips_split"
medip_noregions.path <- "~/storage/data/medips/cells/no_regions"
...
medips.cells200 <- sapply(c("omp_hmc", "omp_mc", "ngn_hmc", "ngn_mc", "icam_hmc", "icam_mc"), function(x) paste(x, "200_chr1.rds", sep="_"))
...
samples.d3a_rpkm <- c("moe_d3a_wt_hmc_rpkm", "moe_d3a_ko_hmc_rpkm", "moe_d3a_wt_mc_rpkm", "moe_d3a_ko_mc_rpkm")
...
samples.tfo <- c("tfo_hmc_full", "omp_hmc_120424_full")
