...
#exons.gg <- ggplot(exons, aes(omp_hmc, ott3_hmc_rep)) + geom_point(alpha=I(1/5), data=exons[sample(1:nrow(exons), 20000),]) + coord_cartesian(xlim=c(0,3), ylim=c(0,3))
exons.gg <- ggplot(exons, aes(omp_hmc, ott3_hmc_rep)) + xlim(0, 3) + ylim(0, 3) + stat_density2d(geom="tile", aes(fill=..density..), contour=F) + scale_fill_gradient(low="white", high="black", limits=c(0, 1))
...
theme_set(theme_classic())
##introns.gg <- ggplot(introns, aes(omp_hmc, ott3_hmc_rep)) + geom_point(alpha=I(1/10), data=introns[sample(1:nrow(introns), 20000),]) + coord_cartesian(xlim=c(0,3), ylim=c(0,3))
introns.gg <- ggplot(introns, aes(omp_hmc, ott3_hmc_rep)) + xlim(0, 3) + ylim(0, 3) + stat_density2d(geom="tile", aes(fill=..density..), contour=F) + scale_fill_gradient(low="white", high="black", limits=c(0, 2.2))
