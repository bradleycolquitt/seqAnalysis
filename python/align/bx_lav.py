...
class Reader(object):
	...
	def close(self):
        ...
        def minimal_src_parse(self):
                if (self.seq1_src == None):
                        if (self.seq1_strand == "+"): revcomp = False
                        else:                         revcomp = "-5'"
                        if (self.seq1_contig == 1): contig = None
                        else:                       contig = self.seq1_contig
	...
	def build_alignment(self,score,pieces):
		...
		size1  = end1 - start1
                ...
                a.add_component(Component(self.seq1_src,start1,size1,self.seq1_strand))
                ...
                a.add_component(Component(self.seq2_src,start2,size2,self.seq2_strand))
		return a
