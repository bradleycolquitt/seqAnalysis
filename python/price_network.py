...
# The following is taken from the graph_tools website
...
while True:  
    print("vertex:", v, "in-degree:", v.in_degree(), "out-degree", v.out_degree(),\
          "age:", v_age[v])
...
# now we can save it
g.save("~/data/networks/price.xml.gz")
...
ylabel("$NP(k_{in})$")
tight_layout()
savefig("/media/data/networks/price-deg-dist.pdf")
savefig("/media/data/networks/price-deg-dist.png")
